...
class DiagnosisTable extends LivewireTableComponent
{
    ...
    public function columns(): array
    {
        if(getLoggedinDoctor()){
            $diagnosisReport = Column::make(__('Report Generated'), 'report_generated')
            ->view('opd_patient_departments.columnDiagnosis.report_generated');
        }else{
            $diagnosisReport = Column::make(__('Report Status'), 'report_generated')
            ->view('opd_patient_departments.columnDiagnosis.report_status');
        }
        return [
