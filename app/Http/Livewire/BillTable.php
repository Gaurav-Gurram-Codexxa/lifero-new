...
class BillTable extends LivewireTableComponent
{
    ...
    public function columns(): array
    {
        if (! getLoggedinPatient()) {
            ...
            $payButton = Column::make(__('messages.bill.pay'),
                'id')->view('bills.pay-bill');
        ...
        return [
            ...
            Column::make(__('messages.bill.total_amount'), 'amount')
                ->view('bills.columns.amount')
                ->sortable()
                ->searchable(),

            Column::make(__('messages.bill.paid_amount'), 'paid_amount')
            ->view('bills.columns.paid_amount')
            ->sortable()
            ->searchable(),

            Column::make(__('messages.bill.due'),'amount')
            ->view('bills.columns.dueAmount')
            ->sortable()
            ->searchable(),
