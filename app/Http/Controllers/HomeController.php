...
class HomeController extends AppBaseController
{
    ...
    public function leadChart(Request $request): JsonResponse
    {
        $input = $request->all();
        $startDate = str_replace('/', '-', $input['start_date']);
        $endDate = str_replace('/', '-', $input['end_date']);
        ...
        $data = $this->dashboardRepository->totalFilterDayLead($formatStartDate, $formatEndDate);

        return $this->sendResponse($data, __('messages.flash.lead_report_generate'));
    }
