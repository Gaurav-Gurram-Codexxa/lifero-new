...
class AppointmentController extends AppBaseController
{
    ...
    public function create(Request $request): View
    {
        ...
        return view('appointments.create', compact('statusArr', 'patient','hospitals'));
    }
    ...
    public function edit(Appointment $appointment): View
    {
        ...
        return view('appointments.edit', compact('hospitals','departments','statusArr', 'appointment', 'doctors', 'slots', 'patient'));
    }
