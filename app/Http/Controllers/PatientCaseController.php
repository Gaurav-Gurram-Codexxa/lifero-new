...
class PatientCaseController extends AppBaseController
{
    ...
    public function edit(PatientCase $patientCase)
    {
        ...
        $patientCaseSession = PatientCaseSession::where('case_id',$patientCase->id)->select('*')->get();
        ...
        return view('patient_cases.edit', compact('patientCaseSession','patientCase', 'patient', 'doctors', 'handlers', 'servicesList', 'services','packages'));
    }
