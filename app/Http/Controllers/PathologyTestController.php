...
class PathologyTestController extends AppBaseController
{
    ...
    public function create(): View
    {
        ...
        return view('pathology_tests.create', compact('data','parameterList'));
    }
    ...
    public function edit(PathologyTest $pathologyTest)
    {
        ...
        return view('pathology_tests.edit', compact('pathologyTest', 'data', 'parameterList', 'pathologyParameterItems'));
    }
