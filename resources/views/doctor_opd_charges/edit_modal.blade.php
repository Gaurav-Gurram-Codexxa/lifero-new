            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        {{ Form::label('new_patient_charge', 'New Patient Charges', ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('new_patient_charge', null, ['class' => 'form-control price-input','required', 'id' => 'editDoctorNewPatientCharge', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
                    </div>
                    <div class="col-md-12 mt-3">
                        {{ Form::label('standard_charge', __('messages.doctor_opd_charge.standard_charge').(':'), ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('standard_charge', null, ['class' => 'form-control decimal-number', 'id' => 'editDoctorStandardCharge']) }}
                    </div>
                </div>
            </div>
