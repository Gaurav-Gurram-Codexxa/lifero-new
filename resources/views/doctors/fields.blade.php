...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('doctor_registration_no', __('messages.doctor.doctor_registration_no').':', ['class' => 'form-label']) }}
            <span class="required"></span>
            {{ Form::text('registration_no', (isset($doctor) ? $doctor->registration_no : ''), ['class' => 'form-control','required']) }}
        </div>
    </div>
