...
<div class="mt-7 overflow-hidden">
    <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
        ...
        <li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0" id="patients-tab" data-bs-toggle="tab" data-bs-target="#dconsultFee"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
            ...
            <div class="tab-content" id="myTabContent">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                    <label for="name"
                                           class="pb-2 fs-5 text-gray-600">{{ __('messages.doctor.specialist').':' }}</label>
                                    <span class="fs-5 text-gray-800">{{$doctorData->registration_no}}</span>
                                </div>
                ...
                <div class="tab-pane fade" id="dconsultFee" role="tabpanel">
                    <div class="container-fluid">
