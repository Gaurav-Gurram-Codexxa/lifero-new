...
{{--        <input type="hidden" id="frontAppointmentDate" value="{{$data['appointmentDate']}}">--}}
    ...
    <div class="col-lg-4 col-md-6">
        <div class="appointment-form__input-block">
            ...
            {{ Form::text('opd_date', null, ['class' => 'form-control   ', 'autocomplete' => 'off', 'id' => 'frontAppointmentOPDDate','required']) }}
        </div>
    </div>
    <div class="col-lg-12">
        <div class="appointment-form__input-block">
        ...
        @if($isEnabledGoogleCapcha == true)
            <div class="form-group col-xl-12">
                @if(config('app.recaptcha.key'))
                    <div class="g-recaptcha" id="appointment-g-recaptcha" data-sitekey="{{config('app.recaptcha.key')}}">
                    </div>
                @endif
            </div>
        @endif
