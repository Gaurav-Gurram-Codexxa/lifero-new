<div class="row gx-10 mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::text('medical_history', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control'),'id' => 'editPrescriptionAddedAt','autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
