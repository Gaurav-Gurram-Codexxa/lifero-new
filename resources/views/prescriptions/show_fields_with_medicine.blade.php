<div class="row">
    ...
    <div class="col-md-4 col-sm-6 co-12 mt-sm-0 mt-5">
        ...
        <div class="d-flex flex-row">
            <label for="name" class="pb-2 fs-5 text-gray-600 me-1">{{ __('messages.prescription.prescription_date') }}:</label>
            <span
...
<div class="col-12">
    <div class="d-flex align-items-center justify-content-between flex-wrap mt-5">
        ...
        <div class="mt-3">
            ...
            <h6 class="text-gray-600 fw-light mt-1">Reg.No : {{ $prescription['prescription']->doctor->registration_no }}</h6>
