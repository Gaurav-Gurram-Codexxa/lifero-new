...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select', 'id' => 'TeleCallerBloodGroup','placeholder'=>__('messages.user.select_blood_group')]) }}
        </div>
    </div>
        ...
        <div class="form-group mb-5">
            ...
            <div class="d-flex align-items-center">
                <div class="form-check me-10">
                    <label class="form-label" for="maleTeleCaller">{{ __('messages.user.male') }}</label>&nbsp;&nbsp;
                    {{ Form::radio('gender', '0', true, ['class' => 'form-check-input', 'id' => 'maleTeleCaller']) }}
                </div>
                <div class="form-check me-10">
                    <label class="form-label" for="femaleTeleCaller">{{ __('messages.user.female') }}</label>&nbsp;
                    {{ Form::radio('gender', '1',false, ['class' => 'form-check-input', 'id' => 'femaleTeleCaller']) }}
                </div>
            </div>
        </div>
    </div>
