...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select', 'id' => 'editTeleCallerBloodGroup','placeholder'=>__('messages.user.select_blood_group')]) }}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['class' => (getLoggedInUser()->theme_mode) ? 'form-control bg-light' : 'form-control bg-white','id' => 'editTeleCallerBirthDate','autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
...
<div class="row mt-3">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('address1', isset($tele_caller->address->address1) ? $tele_caller->address->address1 : null, ['class' => 'form-control ']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('address2',__('messages.user.address2').(':'), ['class' => 'form-label ']) }}
            {{ Form::text('address2', isset($tele_caller->address->address2) ? $tele_caller->address->address2 : null, ['class' => 'form-control ']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('city',__('messages.user.city').(':'), ['class' => 'form-label ']) }}
            {{ Form::text('city', isset($tele_caller->address->city) ? $tele_caller->address->city : null, ['class' => 'form-control ']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('zip',__('messages.user.zip').(':'), ['class' => 'form-label ']) }}
            {{ Form::text('zip', isset($tele_caller->address->zip) ? $tele_caller->address->zip : null, ['class' => 'form-control ', 'maxlength' => '6','minlength' => '6']) }}
        </div>
    </div>
