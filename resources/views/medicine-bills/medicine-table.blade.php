...
<div class="row">
    <div class="row">
        ...
        <div class="form-group col-md-3 mb-5">
            ...
            {{ Form::select('patient_id', (isset($patients) ? $patients : []),null , ['class' => 'form-select', 'required', 'id' => 'patientId', 'placeholder' => __('messages.document.select_patient') , 'data-control' => 'select2']) }}
