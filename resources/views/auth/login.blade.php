            ...
            <form method="post" action="{{ url('/login') }}">
                ...
                <div class="mb-sm-7 mb-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <input type="hidden" value="{{ (session('languageName') == null) ? session('languageName') : checkLanguageSession()}}" name="se_lang">
                    </div>
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary" style="    background-color: #360d37;">{{ __('auth.login.login') }}</button>
                </div>
