    ...
    <div class="col-lg-6">
        ...
        @if(!$isEdit)
            <div class="mb-5 doctor_department d-none">
                ...
                <span class="required"></span>
                {{ Form::select('doctor_department_id', $doctorDepartments, null, ['class' => 'form-select userDoctorDepartment', 'id' => 'userDoctorDepartmentId', 'placeholder' => 'Select Department', 'data-control' => 'select2', 'required']) }}
            </div>
        @endif
