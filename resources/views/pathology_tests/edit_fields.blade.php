<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::text('standard_charge', null, ['class' => 'form-control price-input pathologyStandardCharge', 'readonly', 'required']) }}
        </div>
    </div>
    <div class="col-sm-12">
                        ...
                        @if (isset($pathologyParameterItems))
                            @foreach ($pathologyParameterItems as $key => $pathologyParameterItem)
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::text('patient_result[]', $pathologyParameterItem->patient_result ?? null, ['class' => 'form-control ', 'data-id' => 1, 'required']) }}
                                    </td>
                                    <td>
                                        {{ Form::text('reference_range[]', $pathologyParameterItem->pathologyParameter->reference_range ?? null, ['class' => 'form-control', 'id' => 'rangeId', 'readonly']) }}
                                    </td>
                                    <td>
                                        {{ Form::text('unit_id[]', $pathologyParameterItem->pathologyParameter->pathologyUnit->name ?? null, ['class' => 'form-control', 'id' => 'unitId', 'readonly']) }}
                                    </td>
                                    @if ($key != 0)
