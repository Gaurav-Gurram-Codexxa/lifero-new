<script id="pathologyParameterTemplate" type="text/x-jsrender">
    ...
    <td class="table__item-desc">
        ...
        <td>
            <input class="form-control" name="patient_result[]" type="text">
        </td>
        <td>
            <input class="form-control" required="" value='' name="reference_range[]" id="rangeId" type="text" readonly>
        </td>
        <td>
            <input class="form-control" required="" value='' name="unit_id[]" id="unitId" type="text" readonly>
        </td>
