            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('parameter_name', '', ['id'=>'pathologyParameterName','class' => 'form-control','required']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('reference_range', __('messages.new_change.reference_range').':', ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('reference_range', '', ['id'=>'pathologyParameterRange','class' => 'form-control','required']) }}
                    </div>
                    ...
                    <div class="form-group mb-5">
                        ...
                        {{ Form::textarea('description', '', ['id' => 'BloodIssueRemarks','class' => 'form-control','rows' => 3,'cols' => 3]) }}
                    </div>
                </div>
