                ...
                <div class="row justify-content-center">
                            ...
                            <div class="card plan-card-detail h-100 card-xxl-stretch mx-lg-2">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 fw-bolder">{{ __('messages.subscription_plans.plan_name') }}</h4>
                                        <span class="fs-5 w-50 text-muted">{{$cpData['name']}}</span>
                                    </div>
                                    <div class="d-flex align-items-center py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.new_change.plan_price') }}</h4>
                                    ...
                                    <div class="d-flex align-items-center py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.subscription_plans.start_date') }}</h4>
                                        <span class="fs-5 w-50 text-muted">{{$cpData['startAt']}}</span>
                                    </div>
                                    <div class="d-flex align-items-center py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.subscription_plans.end_date') }}</h4>
                                        <span class="fs-5 w-50 text-muted">{{$cpData['endsAt']}}</span>
                                    </div>
                                    <div class="d-flex align-items-center py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.subscription_plans.used_days') }}</h4>
                                        <span class="fs-5 w-50 text-muted">{{$cpData['usedDays']}} {{ __('messages.prescription.days') }}</span>
                                    </div>
                                    <div class="d-flex align-items-center py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.new_change.remaining_days') }}</h4>
                                        <span class="fs-5 w-50 text-muted">{{$cpData['remainingDays']}} {{ __('messages.prescription.days') }}</span>
                                    </div>
                                    <div class="d-flex align-items-center py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.new_change.used_balance') }}</h4>
                                        <span class="fs-5 w-50 text-muted">
                                        <span class="mb-2">
                                        {{ $getCurrentPlanAdminCurrencySymbol }}
                                        </span>
                                    ...
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.subscription_plans.remaining_balance') }}</h4>
                                        <span class="fs-5 w-50 text-muted">
                    ...
                    <div class="col-xxl-5 col-lg-6 mb-4">
                        <div class="card plan-card-detail h-100 card-xxl-stretch mx-lg-2">
                            <div class="card-header border-0 px-0 bg-transparent">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="fw-bolder text-primary fs-3">{{ __('messages.new_change.new_plan') }}</span>
                                </h3>
                                <hr>
                            </div>
                            <div class="card-body p-0">
                                ...
                                <div class="d-flex align-items-center py-2">
                                    <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.bill.total_days') }}</h4>
                                    <span class="fs-5 w-50 text-muted">{{$newPlan['totalDays']}} {{ __('messages.prescription.days') }}</span>
                                </div>
                                <div class="d-flex align-items-center py-2">
                                    <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.new_change.pre_plan')}}</h4>
                                    <span class="fs-5 w-50 text-muted">
                                        <span class="mb-2">
                                              {{ $getSubscriptionPlanAdminCurrencySymbol }}
                                        </span>
                                ...
                                <div class="d-flex align-items-center py-2">
                                    <h4 class="fs-5 w-50 mb-0 me-3 text-gray-800 fw-bolder">{{ __('messages.new_change.payable_amount')}}</h4>
                                    <span class="fs-5 w-50 text-muted">
                                        <span class="mb-2">
                                           {{ $getSubscriptionPlanAdminCurrencySymbol }}
                                        </span>
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6 ">
                        <div class="email-box">
                            ...
                            <button type="button" class="btn btn-primary d-none d-sm-block">{{ __('messages.landing.subscribe') }}</button>
                            <button type="button"
