            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('receipt_no', null, ['class' => 'form-control advancedPaymentReceiptNo','required','readonly','id'=>'advancedPaymentReceiptNo']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('amount', __('messages.advanced_payment.amount').(':'),['class' => 'form-label required']) }}
                        {{ Form::text('amount', null, ['class' => 'form-control decimal-number','required', 'maxlength' => '7']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('date', __('messages.advanced_payment.date').(':'),['class' => 'form-label required']) }}
                        {{ Form::text('date', null, ['class' => 'form-control bg-white','required','id' => 'advancedPaymentDate', 'autocomplete' => 'off']) }}
                    </div>
                </div>
            </div>
