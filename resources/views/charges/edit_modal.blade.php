            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('standard_charge', null, ['class' => 'form-control decimal-number','required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")' , 'id' =>'editStdCharge']) }}
                    </div>
