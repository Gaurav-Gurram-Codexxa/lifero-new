        ...
        <div class="row">
            <div class="col-xxl-5 col-12">
                <div class="d-sm-flex align-items-center mb-5 mb-xxl-0 text-center text-sm-start">
                    ...
                    <div class="ms-0 ms-sm-10 mt-5 mt-sm-0">
                        <span class="badge bg-light-{{ $data->patientUser->status == 1 ? 'success' : 'danger' }} mb-2">
            ...
            <div class="col-xxl-7 col-12">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 col-sm-6 col-12 mb-6 mb-md-0 d-none">
                        <div class="border rounded-10 p-5 h-100">
                    ...
                    for($i=0;$i<$count;$i++)
                    {
                        $totalAmount +=$data->bills[$i]['amount'];
                        $totalPaidAmount +=$data->bills[$i]['paid_amount'];
                    }
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="border rounded-10 p-5 h-100">
                            <h2 class="text-primary mb-3">
                                <i class="fa-duotone fa-solid fa-indian-rupee-sign text-primary"></i>
                                {{isset($data->bills) ? $dueAmount : 0 }}
                            </h2>
                            <h3 class="fs-5 fw-light text-gray-600 mb-0">{{__('messages.total_due_amount')}}</h3>
                        </div>
                    </div>
...
<div class="mt-7 overflow-hidden">
    <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
        ...
        <li class="nav-item position-relative me-7 mb-3 d-none" role="presentation">
        ...
        <li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pAdvancedPayments"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.advanced_payment.transactions') }}
            </button>
        </li>
        ...
        <li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pPrescription"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="pPrescription" role="tabpanel" aria-labelledby="cases-tab">
            <div class="container-fluid">
                <livewire:patient-prescription-table patient-id="{{ $data->id }}"/>
            </div>
        </div>
    </div>
</div>
