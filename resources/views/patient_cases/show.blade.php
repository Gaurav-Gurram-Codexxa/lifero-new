...
@endsection
@section('css')
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/photoviewer@3.10.0/dist/photoviewer.min.css">
@endsection


@section('scripts')
<script src="https://cdn.jsdelivr.net/npm/photoviewer@3.10.0/dist/photoviewer.min.js"></script>
@endsection
