...
$('#createRadiologyTest, #editRadiologyTest').
    ...
    listen('change', '.charge-category', function (event) {
        ...
        (chargeCategoryId !== '')
            ...
            $('#chargeCode').append($('<option></option>').text(Lang.get('messages.new_change.select_charge'))),$(".rd-test-standard-charge").val('');
    });
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.data !== '') {
                    ...
                    $('#chargeCode').append($('<option></option>').text(Lang.get('messages.new_change.select_charge')))
                    ...
                    $('#chargeCode').append($('<option></option>').
                        text(Lang.get('messages.new_change.select_charge')))
                }
            },
        });
    };
