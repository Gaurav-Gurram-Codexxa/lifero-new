...
Route::middleware('auth', 'verified', 'xss', 'multi_tenant', 'checkUserStatus', 'check_super_admin_role')->group(function () {
    ...
    // Route::middleware(['role:Admin|Tele Caller', ViewOnlyOpenLead::class])->group(function () {
    ...
    // Route::middleware('role:Super Admin|Admin|Patient|Doctor|Receptionist|Nurse|Case Manager|Accountant')->group(function () {
...
// Appointment CHanges 
    ...
    Route::middleware('role:Admin|Patient|Doctor|Receptionist|Nurse|Tele Caller|Case Manager', 'check_menu_access')->group(function () {
