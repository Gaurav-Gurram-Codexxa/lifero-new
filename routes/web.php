...
use App\Http\Middleware\ViewOnlyOpenLead;
...
Route::get('hospitals-list', [AppointmentController::class, 'getHospitalList'])->name('hospitals.list');
...
Route::get('doctor-fee', [AppointmentController::class, 'appointmentFee'])->name('appointments.fee');

Route::get('doctor-fee', [AppointmentController::class, 'appointmentFee'])->name('appointments.fee')->excludedMiddleware('check_menu_access');


Route::get(
    'appointment-calendars',
    [AppointmentCalendarController::class, 'index']
)->name('appointment-calendars.index');
...
Route::post('leads/import', [LeadController::class, 'import'])->name('lead.import');

Route::get('importLeads',[LeadController::class, 'importLeads'])->name('leads.importLeads');

Route::get('convertedLeads',[LeadController::class, 'convertedLeads'])->name('leads.convertedLeads');


Route::get('leads/{lead}/appointment', [LeadController::class, 'appointment'])->name('book-appointment');

Route::get('leads/{lead}/patientCases', [LeadController::class, 'patientCases'])->name('book-session');
...
Route::resource('tele-callers', TeleCallerController::class);
Route::get('tele-callers', [TeleCallerController::class, 'index'])->name('tele-callers.index')->middleware('modules');
Route::post(
    'tele-callers/{teleCaller}/active-deactive',
    [TeleCallerController::class, 'activeDeactiveStatus']
)->name('tele-caller.status');


Route::resource('case-sessions', CaseSessionController::class);
Route::post('store-media', [CaseSessionController::class, 'uploadMedia'])->name('store-media');
...
Route::middleware('auth', 'verified', 'xss', 'multi_tenant', 'checkUserStatus', 'check_super_admin_role')->group(function () {
    ...
    Route::get(
        'patient-paystack-payment-success',
        [PatientPaystackController::class, 'handleGatewayCallback']
    )->name('patient.paystack.success');


    Route::middleware('role:Admin|Patient|Doctor|Receptionist|Nurse|Accountant|Tele Caller|Lab Technician|Pharmacist|Case Manager')->group(function () {
    ...
    Route::middleware(['role:Admin|Doctor|Receptionist|Nurse|Accountant|Tele Caller|Lab Technician|Pharmacist|Case Manager', ViewOnlyOpenLead::class])->group(function () {
        Route::prefix('employee')->group(function () {
    ...
    // Route::middleware('role:Admin|Receptionist|Patient|Tele Caller|Doctor', 'check_menu_access')->group(function () {
    // });
    ...
    Route::resource('patient-cases',PatientCaseController::class);
    ...
    Route::middleware('role:Admin|Doctor|Case Manager|Patient|Receptionist')->group(function () {
        ...
        Route::get('packages/{package}/session', [PackageController::class, 'sessions'])->name('package.details');
    });
    Route::middleware('role:Admin|Patient')->group(function () {
        Route::prefix('employee')->group(function () {
            ...
            Route::get('/servicesRate', [AppointmentAPIController::class, 'getServiceRate']);
            ...
            Route::get('doctorFee', [Employee\BillController::class, 'getDoctorFee'])->name('bill.getDoctorFee');


            Route::get('caseDetails', [Employee\BillController::class, 'getCaseDetails'])->name('bill.getCaseDetails');
        ...
        Route::get(
            'change-bill-payment-status/{id}',
            [BillController::class, 'changeBillPaymentStatus']
        )->name('change-bill-payment-status');
    ...
    Route::middleware('role:Super Admin|Admin|Doctor|Receptionist|Patient')->group(function () {
    ...
    Route::middleware('role:Admin|Accountant|Doctor|Nurse|Receptionist|Lab Technician|Pharmacist|Case Manager')->group(function () {
        ...
        )->where('employeePayroll', '[0-9]+')->name('employee-payrolls.show.modal');
        Route::get('medicine-quantity/{id}', [PrescriptionController::class, 'getMedicineQuantity'])->name('get-medicine-quantity');
    });

    Route::middleware('role:Admin|Accountant|Receptionist|Doctor|Case Manager')->group(function () {
    ...
    Route::middleware('role:Admin|Accountant')->group(function () {
        ...
        Route::get('bills/{bill}/payedit',[BillController::class,'payedit'])->name('bills.payedit');

        Route::post('bills/{bill}/payBill', [BillController::class, 'payBill'])->name('bills.payBill');
    ...
    Route::middleware('role:Admin|Receptionist|Lab Technician|Pharmacist')->group(function () {
        ...
        Route::get(
            'radiology-tests/get-charge-code/{id}',
            [RadiologyTestController::class, 'getChargeCode']
        )->name('radiology.test.charge.code')->withoutMiddleware('check_menu_access');
    ...
    Route::middleware('role:Admin|Receptionist|Doctor|Case Manager')->group(function () {
    ...
    Route::middleware('role:Admin')->group(function () {
        ...
        Route::post(
            'users/{user}/active-deactive',
            [UserController::class, 'activeDeactiveUserStatus']
        )->name('hospital.users.status');
        ...
        Route::post(
            'accountants/{accountant}/active-deactive',
        ...
        Route::post(
            'front-settings',
            [FrontSettingController::class, 'update']
        )->name('front.settings.update')->withoutMiddleware('xss');
        ...
        Route::get('advanced-payments',[AdvancedPaymentController::class, 'index'])->name('advanced-payments.index')->middleware('modules');
        ...
        Route::get(
            'users-list',
            [DepartmentController::class, 'getUsersList']
        )->name('users.list')->middleware('check_menu_access');
    ...
    Route::middleware('role:Admin|Doctor|Receptionist|Lab Technician')->group(function () {
        ...
        Route::get(
            ...
            [PatientDiagnosisTestController::class, 'diagnosisReport']
        )->name('patient.diagnosis.report');
        Route::post(
            'patient-diagnosis-report/{id}',
            [PatientDiagnosisTestController::class, 'reportStatus']
        )->name('patient.diagnosis.report.status');
    });
    ...
    Route::middleware('role:Admin|Patient|Doctor|Receptionist|Accountant|Case Manager|Nurse', 'check_menu_access')->group(function () {
        Route::get(
            ...
            [DocumentController::class, 'downloadMedia']
    ...
    Route::middleware('role:Admin|Doctor')->group(function () {
        Route::get(
            'investigation-download/{investigationReport}',
            [InvestigationReportController::class, 'downloadMedia']
        )->name('investigation.reports.download');
    });
    ...
    Route::middleware('role:Admin|Doctor|Receptionist|Nurse')->group(function () {
        ...
        Route::get(
            ...
            [OpdPatientDepartmentController::class, 'show']
        )->name('opd.patient.show');
        Route::get(
            'opds/{opdPatientDepartment}/edit',
            [OpdPatientDepartmentController::class, 'edit']
...
Route::prefix('super-admin')->middleware('auth', 'verified', 'xss', 'role:Super Admin', 'checkUserStatus', 'check_impersonate')->group(function () {
    ...
    Route::get('tax', [TaxController::class, 'index'])->name('super.admin.tax.index');
    Route::get('tax/create', [TaxController::class, 'create'])->name('super.admin.tax.create');
    Route::post('tax', [TaxController::class, 'store'])->name('super.admin.tax.store');
    Route::get('tax/{tax}/edit', [TaxController::class, 'edit'])->name('super.admin.tax.edit');
    Route::delete('tax/{tax}', [TaxController::class, 'destroy'])->name('super.admin.tax.delete');
    Route::patch('tax/{id}', [TaxController::class, 'update'])->name('super.admin.tax.update');

    Route::get('reports', [ReportController::class, 'index'])->name('super.admin.reports.index');

    Route::get('sales-reports', [ReportController::class, 'salesReport'])->name('super.admin.sales_report.index');

    Route::get('telecallerRecord', [ReportController::class, 'telecallerRecord']);
    ...
    Route::get('lead-chart', [HomeController::class, 'leadChart'])->name('super.admin.lead.chart');
...
// Adding features to super admin panel
    ...
    Route::get(
        'hospital-billing-modal/{id}',
        [HospitalController::class, 'billingModal']
    )->name('super.admin.hospital.billing.modal');
    Route::get(
        'hospital-transaction',
        [HospitalController::class, 'transactionIndex']
    )->name('super.admin.hospital.transaction.index');
    ...
    )->name('super.admin.subscription.plans.index');
    Route::post(
    ...
    )->name('super.admin.subscription.plans.create');
    Route::post(
        'subscription-plans',
        [SubscriptionPlanController::class, 'store']
    )->name('super.admin.subscription.plans.store');
    Route::get(
        'subscription-plans/{subscriptionPlan}/edit',
        [SubscriptionPlanController::class, 'edit']
    )->name('super.admin.subscription.plans.edit');
    Route::put(
        'subscription-plans/{subscriptionPlan}',
        [SubscriptionPlanController::class, 'update']
    )->name('super.admin.subscription.plans.update');
    Route::get(
        'subscription-plans/{subscriptionPlan}',
        [SubscriptionPlanController::class, 'show']
    )->name('super.admin.subscription.plans.show');
    Route::delete(
        'subscription-plans/{subscriptionPlan}',
        [SubscriptionPlanController::class, 'destroy']
    )->name('super.admin.subscription.plans.destroy');
    ...
    // Transactions routes
    Route::get(
        'subscriptions-hospitals',
        [SubscriptionPlanController::class, 'showSubscriptionsLists']
    )->name('subscriptions.list.index');
    Route::get(
        'subscriptions-hospitals/{id}',
        [SubscriptionPlanController::class, 'showSubscriptions']
    )->name('subscriptions.list.show');
    Route::get(
        'subscriptions-hospitals/{id}/edit',
        [SubscriptionPlanController::class, 'editSubscriptions']
    )->name('subscriptions.list.edit');
    Route::patch(
        'subscriptions-hospitals/{id}',
        [SubscriptionPlanController::class, 'updateSubscriptions']
    )->name('subscriptions.list.update');
    ...
    Route::post(
        ...
        [Landing\AdminTestimonialController::class, 'update']
    ...
    Route::delete(
        ...
        [Landing\SubscribeController::class, 'destroy']
    ...
    Route::get(
        '/notification/{notification}/read',
        [NotificationController::class, 'readNotification']
    )->name('admin.read.notification');
    Route::post(
        '/read-all-notification',
        [NotificationController::class, 'readAllNotification']
    )->name('admin.read.all.notification');
});
